INSERT INTO `yandexmapobj`.`objectmark` (`id`, `iconContent`, `latitude`, `longitude`, `balloonContentBody`)
VALUES ('1', 'Москва', '55.755679065', '37.63036819877796', 'Московский район');
INSERT INTO `yandexmapobj`.`objectmark` (`id`, `iconContent`, `latitude`, `longitude`)
...
INSERT INTO `yandexmapobj`.`objectmark` (`id`, `iconContent`, `latitude`, `longitude`)
VALUES ('5', 'Берлин', '52.554347', '13.288617');
